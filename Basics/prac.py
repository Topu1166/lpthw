...
#
##Create a for loop that counts the numbers of even and odd integers in the list
##below. It should return two strings on seperate lines that prints sentences. And
##what would be the sum of even and odd integers write them seperately. 
#
#num_list = [85, 23, 85, 2, 8, 28, 26, 96, 3, 1, 100] 
#
...
#    even_sum = 0 
#
#    for num in num_list:       #odd count
#        if num % 2 != 0:
#            odd_count += 1 
#            odd_sum += num
#
#        elif num % 2 == 0:    #even count
#            even_count += 1
#            even_sum += num
#
#    return odd_count, odd_sum, even_count, even_sum 
#
##odd_count, odd_sum, even_count, even_sum = even_odd(num_list) 
#result = even_odd(num_list) 
#print("There are {} odd numbers and the sum of them is {}.\nThere are {} even numbers and the sum of them is {}.".format(*result))
#
##Print triangles and squares, rectangle using for loop
#
##SQUARE:
#print("----" * 10) 
#print("SQUARE\n") 
...
# 1. Whrite a Python program too create a list with the numbers 1 to 5 and print it. 
py_list = [1, 2, 3, 4, 5] 
print(py_list) 
print("~~~" * 10)
# 2. given the list belw, print the third element. 
word = py_list[2] 
print(f"Printing the 3rd element: {word}") 

# 3. Change the second element of the list below to "grape" and print the updated list. 

print("~~~" * 10)
fruits = ['mango', 'guava', 'lichi', 'apple', 'bananna'] 
fruits[1] = 'grape'
print(f"The guava is changed to: {fruits}")

# 4. Add 'orange' to the end of the list below. 

print("~~~" * 10)
fruits.append('orange') 
print(f"A fruit has been added at the end of the list that is: {fruits}") 
print(f"There are {len(fruits)} items in the list.") 

print("~~~" * 10)
# 5. Remove 'blue' from the list below and print the updated list. 
del fruits[2] 
print(f"The 'lichie' has been deleted from fruits: {fruits}") 

print("~~~" * 10)
# 6. Given the list below, print the first three elements usning slicing. 
first_element = fruits[:1]
print(fruits) 
print(f'Printing the first element of the list fruits: {first_element}')
...
print("~~~" * 10)
print('Does apple exists in fruits: ','apple' in fruits)
...
print("~~~" * 10)
# 10. Create a new list containing the squares of numbers from 1 to 5 using list comprehension
#without list of comprehension using a list
squares_num = [1, 2, 3, 4, 5] 
squares = [] 
...
#squares of numbers 
square_number = [i ** 2 for i in [2, 8, 88, 23, 5]] 
print(square_number)

print("~~~" * 10)
#11. Write a Python program to reverse a list without using reverse() or slicing. (Bonus Challenge) 
